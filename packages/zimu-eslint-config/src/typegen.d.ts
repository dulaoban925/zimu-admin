...
export type ConfigNames = 'zimu/ignores/global' | 'zimu/ignores/git' | 'zimu/comments' | 'zimu/js' | 'zimu/js/scripts' | 'zimu/js/test' | 'zimu/imports' | 'zimu/imports/allow-default-export' | 'zimu/sort/imports' | 'zimu/unicorn' | 'zimu/node' | 'zimu/regexp' | 'typescript-eslint/base' | 'typescript-eslint/eslint-recommended' | 'typescript-eslint/recommended' | 'zimu/ts' | 'zimu/ts/dts' | 'zimu/ts/test' | 'zimu/ts/cjs' | 'zimu/json' | 'typescript-eslint/base' | 'typescript-eslint/eslint-recommended' | 'typescript-eslint/recommended' | 'zimu/ts' | 'zimu/vue/ts' | 'zimu/vue' | 'zimu/vue/reactivity' | 'zimu/prettier' | 'zimu/markdown/recommended/plugin' | 'zimu/markdown/recommended/processor' | 'zimu/markdown/recommended/code-blocks' | 'zimu/markdown'
